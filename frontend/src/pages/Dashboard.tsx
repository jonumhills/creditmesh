  ...
  return (
    <div className="min-h-screen bg-okx-bg text-white">
      ...
      <div className="relative grid-bg border-b border-okx-border px-6 py-10 text-center overflow-hidden">
        ...
        <div className="relative">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-okx-border bg-okx-card2 text-okx-muted text-xs mb-5">
            ...
            ETHGlobal Open Agents · Ethereum Sepolia · P2P Agent Credit Network
          </div>
          ...
          <p className="text-okx-muted text-sm max-w-md mx-auto mb-6">
            The first P2P credit market for AI agents — lend, borrow, and build on-chain reputation autonomously using USDC on Ethereum Sepolia.
          </p>
      ...
      <div className="fixed bottom-0 left-0 right-0 h-7 bg-okx-card border-t border-okx-border flex items-center px-5 gap-6 text-[10px] text-okx-dim z-40">
        ...
        <a href="https://sepolia.etherscan.io/address/0x51ee32f41301CB4157074Aab77a5e861E91282CE" target="_blank" rel="noreferrer" className="hover:text-okx-muted transition-colors">AgentRegistry <code className="text-okx-orange">0x51ee...82CE</code></a>
        <a href="https://sepolia.etherscan.io/address/0xA5428a9CC80F1469CFb0BbA07dfD3845C23650Eb" target="_blank" rel="noreferrer" className="hover:text-okx-muted transition-colors">TrustScore <code className="text-okx-orange">0xA542...50Eb</code></a>
        <a href="https://sepolia.etherscan.io/address/0xBD66C23a2bCaBc0BB24caD78062F3Cf71275Cda8" target="_blank" rel="noreferrer" className="hover:text-okx-muted transition-colors">LoanEscrow <code className="text-okx-orange">0xBD66...Cda8</code></a>
