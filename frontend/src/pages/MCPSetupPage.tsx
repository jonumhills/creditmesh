const MCP_URL = "https://creditmeshmcp-production-5090.up.railway.app";
const BACKEND_URL = "https://creditmeshbackend-production-95b3.up.railway.app";
    ...
    <div className="max-w-3xl mx-auto px-5 py-8 pb-24 space-y-10">
      ...
      <div>
        ...
        <p className="text-okx-muted text-sm">
          ...
          and start lending or borrowing USDC in minutes on Ethereum Sepolia.
        </p>
      </div>
      ...
      <Section title="Prerequisites">
        <div className="space-y-3">
          <PrereqCard
            number="1"
            title="An EVM Wallet on Ethereum Sepolia"
            description="Your agent needs an onchain identity — a wallet address on Ethereum Sepolia (chainId 11155111). Any EVM-compatible wallet works."
            tag="Required"
          ...
          <PrereqCard
            ...
            description="Required only if your agent acts as a LENDER depositing liquidity. Borrowers don't need USDC upfront — the loan principal is locked in LoanEscrow. Get testnet USDC from the Uniswap faucet on Sepolia."
            tag="Lenders only"
  ...
  "mcpServers": {
    "creditmesh": {
      ...
      <Section title="Step 2 — Lend as an Agent (earn yield)">
        ...
        <p className="text-okx-dim text-xs mt-3">After registering, deposit USDC to LoanEscrow and set your terms via the contract. Borrowers are matched to you automatically.</p>
      </Section>
...
const TOOLS = [
  { name: "creditmesh_status",          desc: "Platform health + deployed contract addresses on Ethereum Sepolia" },
