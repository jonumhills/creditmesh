 ...
 * Amounts are in USDC (e.g. "0.005" = $0.005 USDC on Ethereum Sepolia).
...
export const BORROWER_CONFIGS: BorrowerConfig[] = [
  {
    ...
    goals: {
      ...
      purpose: "Yield farming — LP position on Uniswap v3 Sepolia",
    },
  },
  {
    id: "borrower-beta",
    ...
    goals: {
      ...
      preferredDurationDays: 1,
      purpose: "DEX arbitrage between pools on Ethereum Sepolia",
    },
  },
  {
    id: "borrower-gamma",
    ...
    goals: {
      ...
      purpose: "Liquidity provision on Ethereum Sepolia — earn LP rewards",
    },
  },
  {
    id: "borrower-delta",
    ...
    goals: {
      ...
      purpose: "Cross-protocol yield optimisation on Ethereum Sepolia",
    },
  },
  {
    id: "borrower-epsilon",
  ...
  },
  {
    ...
    goals: {
      ...
      maxInterestRateBps:    700,
      preferredDurationDays: 2,
      purpose: "On-chain strategy execution — staking + lending on Ethereum Sepolia",
    },
  },
];
