...
/// @title LoanEscrow
/// @notice Holds lender USDC liquidity and manages the loan lifecycle on Ethereum Sepolia.
///         Tracks loan state and enforces trust score requirements onchain.
contract LoanEscrow is Ownable, ReentrancyGuard {
    ...
    /// @notice Record repayment onchain.
